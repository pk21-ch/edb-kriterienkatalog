...
- Erstellung Automatisierungskonzept
  ...
  2. Es werden mindestens zwei Pain Points ausgewählt und für die Automatisierung beschrieben.
  3. Es wird ein Umsetzungskonzept mit Zeitplan und Ressourcenbedarf erstellt.
  4. Der Mehrwert aus der Automatisierung ist beschrieben und nachvollziehbar.

- Anforderungen und Tests
  1. Mindestens drei Anwendungsfälle werden auf Basis der Anforderungen geprüft.
  2. Tests werden systematisch dokumentiert (z. B. Testprotokoll mit Resultat).
  3. Die Resultate werden nach Bestehen/Nichtbestehen bewertet.
  4. Abweichungen werden mit Ursache und Massnahme erfasst.

- Testkonzept
  1. Funktionale Tests – Alle Kernfunktionen (Navigation, Formulare, Suche, Chatbot, Login/Logout) funktionieren wie spezifiziert.
  2. Usability & Accessibility Tests – Bedienbarkeit mit Screenreader, Tastatur-Navigation, Kontraste und Responsiveness auf mobilen Geräten sind korrekt umgesetzt.
  3. Kompatibilitätstests – Unterstützung relevanter Browser-Versionen (Chrome, Firefox, Safari, Edge) sowie mobiler Betriebssysteme ist gewährleistet.
...
- Workshop vorbereiten und strukturieren
  ...
  2. Agenda mit Zeitrahmen und Verantwortlichkeiten ist erstellt.
  3. Infrastruktur ist getestet und bereitgestellt.
  4. Veranstaltungsform ist begründet und kommuniziert (z. B. Einladung mit Agenda als PDF).

- Erstellung Schulungsunterlagen
  1. Der Inhalt deckt alle in der Benutzeranleitung erwähnten Kernfunktionen ab.
  2. Die Schulungsunterlagen enthalten mindestens zwei praxisnahe Übungen, bei denen reale Arbeitsdaten oder typische Geschäftsfälle verwendet werden.
  3. Zu jeder Übung wird ein überprüfbares Soll-Ergebnis bereitgestellt.
  4. Für mindestens einen praktischen Anwendungsfall wird ein vollständiges Beispielprojekt bereitgestellt (inkl. Dateien, Einstellungen, Zwischenschritten).

- Benutzerdokumentation
  1. Die Benutzerdokumentation enthält eine korrekte Systemübersicht.
  2. Sie enthält eine umfassende Installations- & Setup-Anleitung.
  3. Sie enthält korrekte Beschreibungen zu den Konfigurationen und Schnittstellen (APIs).
  4. Sie deckt Sicherheitsaspekte, Wartung und Betrieb ab.

- Meetings und Workshops planen und moderieren I
  1. Dauer, max. Teilnehmerzahl, Ressourcen, Infrastruktur und Budget sind realistisch und grob definiert.
  2. Die Moderationstechniken sind gut beschrieben und praxisnah umsetzbar.
  3. Die Strategie enthält mehrere bewährte Methoden zur aktiven Einbindung der Teilnehmenden und ermöglicht die gezielte Steuerung des Workshops.
...
- Controlling
  1. Die Aktivitäten werden systematisch ausgewertet.
  2. Die Aktivitäten werden in einem verständlichen und übersichtlichen Report dargestellt. Die relevanten KPIs werden betrachtet und richtig interpretiert.
  3. Die Haupterkenntnisse sind zusammengefasst festgehalten.
  4. Es wird eine klare Handlungsempfehlung ausgesprochen.

- Prozess visualisieren und dokumentieren
  1. Die Visualisierung enthält mindestens 7 Schritte mit Start- und Endpunkt.
  2. Jeder Prozessschritt wird mit einer eindeutigen Rollen- oder Verantwortlichkeitszuordnung versehen.
  3. Das Prozessmodell enthält mindestens zwei Entscheidungspunkte mit klar definierten Bedingungen.
  4. Die Dokumentation enthält eine Liste von mindestens drei Prozesskennzahlen (KPIs), die den Ablauf messbar machen (z. B. Durchlaufzeit, Fehlerquote).

- Daten sichten
  1. Die Herkunft der Datenquellen ist deklariert und nachvollziehbar.
  2. Menge/Volume ist beschrieben.
  3. Vielfalt/Variety ist beschrieben.
  4. Geschwindigkeit/Velocity ist beschrieben.
  5. Zuverlässigkeit/Veracity ist beschrieben.

- Strukturvergleich und Modellierung
  1. Zwei Datensätze werden strukturell analysiert und verglichen.
  2. Gemeinsame Datenfelder werden identifiziert und tabellarisch dargestellt.
  3. Ein einfaches Datenmodell (z. B. ER-Diagramm) wird erstellt.
  4. Das Modell wird mit einer schriftlichen Erläuterung ergänzt (150–250 Wörter).

- Prozessbeschreibung erstellen
  1. Es wird eine schriftliche Prozessbeschreibung mit mindestens sechs klar formulierten Schritten erstellt.
  2. Ein Flowchart oder Diagramm des Prozesses wird mit geeignetem und begründetem Tool visualisiert.
  3. Jeder Prozessschritt enthält konkrete Eingaben und erwartete Ergebnisse (Input/Output).
  4. Für den Prozess wird mindestens eine verantwortliche Rolle pro Schritt eindeutig benannt.

- Ressourcenauswahl und Konsistenzprüfung
  1. Notwendige Ressourcen sind basierend auf der Empfehlung des Plattformbetreibers ausgewählt (Performance, Speicherbedarf, Verfügbarkeit, Kosten, Zugriff).
  2. Es wird ein Umsetzungskonzept mit Zeitplan und Ressourcenbedarf erstellt.
  3. Drei geeignete Plattformen/Tools werden verglichen (mit Tabelle).
...
- Datenerhebung
  ...
  2. Fehlende oder doppelte Werte werden identifiziert und entfernt.
  3. Die Formatierung wird bei allen Feldern vereinheitlicht (Datum, Zahlen, Einheiten).
